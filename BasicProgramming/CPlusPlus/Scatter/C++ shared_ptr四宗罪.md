...
所有需要在成员方法中获取指向this的`shared_ptr`的类型，都必须以[CRTP](https://link.jianshu.com/?t=http://en.wikipedia.org/wiki/Curiously_recurring_template_pattern)手法继承自`enable_shared_from_this`。即：
