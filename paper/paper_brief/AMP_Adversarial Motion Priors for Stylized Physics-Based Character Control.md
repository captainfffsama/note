...
姿态使用 [6D法切向量表示法](../../DL_knowlege/空间相关/6D法切向量表示法.md) 。基座坐标系基座正面为 x，上方为 y
...
这里 action $a_t$ 使用关节位置来表示，如果是铰链关节，比如人膝盖手肘，就是 1 自由度的关节角，若是球形关节，使用 [3D旋转变量表示法](../../DL_knowlege/空间相关/3D旋转变量表示法.md)
